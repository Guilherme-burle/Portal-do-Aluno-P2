...
urlpatterns = [
    ...
    path('addD&F', views.desempenho_create, name='addD&F'),
    path('listD&F/', views.desempenho_list, name='listD&F'),
    path('editD&F/editar/<int:id>/', views.desempenho_edit, name='editD&F'),
