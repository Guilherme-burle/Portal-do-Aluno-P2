...
@login_required
def viewDFAluno(request):
    desempenhos = DesempenhoFrequencia.objects.filter(aluno__user=request.user)
    return render(request, 'desempenho_frequencia/view_aluno.html', {'desempenhos': desempenhos})