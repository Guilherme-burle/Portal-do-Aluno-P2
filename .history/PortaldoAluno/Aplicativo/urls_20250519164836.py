...
urlpatterns = [
    ...
    path('desempenho/adicionar/', views.desempenho_create, name='desempenho_create'),
    path('desempenho/', views.desempenho_list, name='desempenho_list'),
    path('desempenho/editar/<int:id>/', views.desempenho_edit, name='desempenho_edit'),
